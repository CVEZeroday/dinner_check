...
execute_process(
  COMMAND "/data/data/com.termux/files/usr/bin/git" --git-dir=.git show-ref "release-1.12.0"
  WORKING_DIRECTORY "/data/data/com.termux/files/home/dinner_check/_deps/googletest-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/data/data/com.termux/files/home/dinner_check/_deps/googletest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/data/data/com.termux/files/home/dinner_check/_deps/googletest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
...
if(init_submodules)
  execute_process(
    COMMAND "/data/data/com.termux/files/usr/bin/git" --git-dir=.git submodule update --recursive --init 
    WORKING_DIRECTORY "/data/data/com.termux/files/home/dinner_check/_deps/googletest-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
